...
if ($_REQUEST && $_REQUEST['ajax']) {
	...
	print("<thead class='thead-props'>");
	print("<tr class='title-row'>");
	print("<th></th>");
	...
	if ($orientation_type == "if_columns") {
		...
		if (!$an_ifstat_is_displayed) {
			print("<tr class='content-row'><td><b>" . gettext('All statistics are hidden.') . "</b></td></tr>");
		}
	} else {
		...
		if (!$an_interface_is_selected) {
			print("<tr class='content-row'><td><b>" . gettext('All interfaces are hidden.') . "</b></td></tr>");
		} else if (!$an_interface_is_displayed) {
			print("<tr class='content-row'><td><b>" . gettext('All selected interfaces are down.') . "</b></td></tr>");
		}
	}
...
?>
<table id="<?=htmlspecialchars($widgetkey)?>-iftbl" class="table ">
	<tr class="content-row"><td><?=gettext("Retrieving interface data")?></td></tr>
</table>
