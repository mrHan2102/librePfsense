...
<table id="dyn_dns_status" class="table ">
	...
	?>
	<tr class="content-row" ondblclick="document.location='<?=$dblclick_location;?>?id=<?=$locationid;?>'"<?=!isset($dyndns['enable'])?' class="disabled"':''?>>
