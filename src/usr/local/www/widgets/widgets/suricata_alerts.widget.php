...
<table class="table">
	...
	<tbody class="tbody-props" id="suricata-alert-entries">
	<?php
	...
	?>
				<tr class="content-row">
					...
					<img  alt="" <?php if ($alert['instanceid'] =='WAN') echo 'src="./WAN-network.svg"'; else echo 'src="./LAN-network.svg"' ; ?>><br/>
						<?=$alert['dateonly']; ?> <?=$alert['timeonly']; ?>
					</td>
					<td class="ip-network" style="overflow: hidden; text-overflow: ellipsis;" nowrap>
