...
<!-- close the body we're wrapped in and add a configuration-panel -->
	...
	<?php echo "class= " . "'" ."form-footer" "panel-footer". ($user_settings['widgets'][$widgetkey]["picturewidget"] != null ? " collapse": ""). "'";  ?>>

<form action="/widgets/widgets/picture.widget.php" method="post" enctype="multipart/form-data" class="form-horizontal form-widgets">
