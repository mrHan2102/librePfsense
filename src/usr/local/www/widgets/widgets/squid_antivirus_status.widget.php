...
function squid_antivirus_bases_info() {
	$db = '<table class="table table-striped  table-condensed"><tbody class = "tbody-props">';
	$db .= '<tr class = "content-row-squid"><th>Database</th><th>Date</th><th>Version</th><th>Builder</th></tr>';
