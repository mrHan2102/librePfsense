	...
	<div class="row align-middle chart-container">
		...
		<div class="col-sm-6">
			<div class="d-flex align-center">
				...
				<div class="ml-3">
					<h5 style="margin-bottom: 2px"><?= $used ?></h5>
		...
		<div class="col-sm-6">
			<div class="d-flex align-center">
				...
				<div class="ml-3">
					<h5 style="margin-bottom: 2px"><?= $usedPercent ?>%</h5>
					<p style="font-size: 12px;">size <?= $size ?></p>
				</div>
			</div>
		</div>
	...
	<div class="row align-middle chart-container">
		...
		<div class="col-sm-6">
			<div class="d-flex align-center">
				...
				<div class="ml-3">
					<h5 style="margin-bottom: 2px"><?= $used2 ?></h5>
					<p style="font-size: 12px;">size <?= $size2 ?></p>
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="d-flex align-center">
				...
				<div class="ml-3">
					<h5 style="margin-bottom: 2px"><?= $usedPercent2 ?>%</h5>
					<p style="font-size: 12px;">size <?= $size2 ?></p>
				</div>
			</div>
		</div>
